...
class LocalLLMInterface(BaseLLMInterface):
    ...
    def generate_response(
        ...
        messages = [
            {
                "role": "system",
                "content": f"""You are MoJoAssistant, a helpful AI with a tiered memory system.
...
Keep your response concise, relevant, and helpful.""",
        ...
        payload = {
            ...
            "temperature": 0.7,
            "max_tokens": min(
                1024, self.context_length // 4
            ),  # Use 1/4 of context for output
            "stream": False,
        }
            ...
            if response.status_code == 200:
                ...
                for line in response.iter_lines():
                    if line:
                        ...
                        if (
                            line_text.startswith("data: ")
                            and line_text != "data: [DONE]"
                        ):
                            try:
